...
class Arrendatario
{
    ...
    #[ORM\OneToMany(targetEntity: Propiedad::class, mappedBy: 'arrendatario')]
    ...
    public function addPropiedad(Propiedad $propiedad): static
    {
        if (!$this->propiedades->contains($propiedad)) {
            ...
            $propiedad->setArrendatario($this);
        }
        return $this;
    }
    ...
    public function removePropiedad(Propiedad $propiedad): static
    {
        if ($this->propiedades->removeElement($propiedad)) {
            if ($propiedad->getArrendatario() === $this) {
                $propiedad->setArrendatario(null);
            }
        }
        return $this;
    }
